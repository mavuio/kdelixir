...
async function activate(context) {
    const disposable = vscode.commands.registerCommand("kdelixir.toggleUnderscore", function () {
    ...
    const disposable2 = vscode.commands.registerCommand("kdelixir.addGuards", function () {
        // Get the active text editor
        const editor = vscode.window.activeTextEditor;
        if (editor) {
            const document = editor.document;
    ...
    const disposable3 = vscode.commands.registerCommand("kdelixir.copyModuleName", async function (clicked_file, selected_files) {
...
//# sourceMappingURL=kdelixir.js.map
